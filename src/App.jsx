...
//         <Route path="/destinations/:slug" element={<DestinationDetail />} />
//         <Route
//           path="/destination-itineraries/:destinationId"
//           element={<DestinationItineraries />}
//         />

//         {/* ===== ITINERARY ===== */}
//         <Route path="/itineraries/:id" element={<ItineraryDetails />} />
//         <Route
//           path="/destinations/:slug/packages/:packageId"
//           element={<PackageDetail />}
//         />

//         {/* ===== TOUR / RESORT ===== */}
//         <Route path="/resort-detail/:id" element={<ResortDetails />} />
//         <Route path="/destinations/:slug/detail" element={<TourDetails />} />
...
//       {/* ================= CHAT WIDGET FIX ================= */}
//       <div className="chat-widget-safe">
//         <ChatWidget />
//       </div>
//     </Router>
//   );
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        {/* ===== VIEW ALL ===== */}
        <Route path="/packages/:type" element={<ViewAll />} />
