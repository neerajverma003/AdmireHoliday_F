          ...
          <div className="relative z-30 text-center text-white max-w-4xl px-5">
            <div className="animate-fade-in-up">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center flex-wrap">
                ...
                <button className="px-8 py-3 text-base font-semibold rounded-md bg-white text-gray-800 border-2 border-white min-w-[140px]   hover:-translate-y-0.5 transition-all duration-300" onClick={handlelearnmore}>
                  Learn More
                </button>
              </div>
              {/* Plan Journey Button */}
