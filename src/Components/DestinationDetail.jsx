...
const DestinationDetail = () => {
  ...
  const destinations = [
    {
      ...
      mainImage:
        "https://media.gettyimages.com/id/472909442/photo/backwaters-of-kerala.jpg?s=612x612&w=0&k=20&c=ibwRiZJZGcxG5MLWFUowcXM9XK3nZnklk9ZH1Qus3C4=",
      images: [
    ...
    },
    {
      ...
      type: "domestic",
      description:
        "Explore the rugged beauty of the Himalayas with ancient monasteries, crystal-clear lakes, and thrilling adventures in Leh Ladakh.",
      mainImage:
        "https://images.unsplash.com/photo-1627991272082-8a10efb0e84e?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Experience high-altitude passes, tranquil lakes, and ancient monasteries in this adventurous Ladakh tour.",
        },
        {
          id: "p7",
          ...
          description:
            "Perfect for first-time travelers looking to explore the beauty and culture of Ladakh.",
        },
      ],
    },
    {
      ...
      type: "domestic",
      description:
        "Experience the vibrant city life of Mumbai — the city that never sleeps, filled with historic landmarks, beaches, street food, and Bollywood glamour.",
      mainImage:
        "https://images.unsplash.com/photo-1548013146-ec74e5c1c3f9?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Dive into the heart of Mumbai with guided tours to iconic spots, vibrant markets, and local delicacies.",
        },
        {
          id: "p9",
          ...
          description:
            "Explore the film capital of India with exclusive Bollywood experiences and beachside fun.",
        },
      ],
    },
    {
      ...
      type: "domestic",
      description:
        "Step into the Pink City of Jaipur, known for its majestic forts, royal palaces, vibrant bazaars, and rich cultural heritage.",
      mainImage:
        "https://images.unsplash.com/photo-1583227266026-ecbe99145a41?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Explore the regal side of Rajasthan with guided tours through forts, palaces, and traditional bazaars.",
        },
        {
          id: "p11",
          ...
          description:
            "Immerse yourself in the colorful culture, folk music, and authentic Rajasthani cuisine.",
        },
      ],
    },
    {
      ...
      type: "domestic",
      description:
        "Discover the charm of Hyderabad — a city where royal heritage meets modern IT hubs, famous for its monuments, biryani, and bustling bazaars.",
      mainImage:
        "https://images.unsplash.com/photo-1618221461675-4e7162d9935f?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Explore the historical wonders of Hyderabad, including its grand forts and royal palaces.",
        },
        {
          id: "p13",
          ...
          price: "₹13,000",
          highlights: [
            "Hyderabadi Biryani Tour",
            "Nightlife at Jubilee Hills",
            "Shilparamam",
          ],
          description:
            "Enjoy local cuisine, traditional arts, and the cultural essence of Hyderabad in this unique experience.",
        },
      ],
    },
    {
      ...
      type: "domestic",
      description:
        "Explore Chennai — a coastal city blending ancient temples, colonial architecture, vibrant culture, and the warmth of Tamil tradition.",
      mainImage:
        "https://images.unsplash.com/photo-1610353302454-16575924cd4b?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Get a taste of Chennai’s culture, heritage, and coastal charm with this short and sweet city tour.",
        },
        {
          id: "p15",
          ...
          description:
            "Perfect for culture lovers and spiritual seekers wanting to experience Chennai’s soul.",
        },
      ],
    },

    {
      ...
      type: "domestic",
      description:
        "Known as the Orange City of India, Nagpur offers a unique blend of heritage, nature, spiritual sites, and regional flavors.",
      mainImage:
        "https://images.unsplash.com/photo-1622623259021-6a4e694c4a63?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Ideal for a relaxed spiritual and historical getaway in the center of India.",
        },
        {
          id: "p17",
          ...
          description:
            "Perfect for nature lovers looking to unwind with lakeside views and serene gardens.",
        },
      ],
    },

    {
      ...
      type: "domestic",
      description:
        "A charming port city blending colonial heritage, vibrant markets, and serene backwaters.",
      mainImage:
        "https://images.unsplash.com/photo-1598106480422-0fc7697f2d3d?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Explore Cochin’s colonial legacy and multicultural roots with local experiences.",
        },
      ],
    },

    {
      ...
      type: "domestic",
      description:
        "India’s Silicon Valley, filled with lush gardens, modern tech hubs, and vibrant nightlife.",
      mainImage:
        "https://images.unsplash.com/photo-1623318061226-21347c84c005?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "A mix of nature, colonial charm, and urban exploration in Bangalore.",
        },
      ],
    },
    {
      ...
      type: "domestic",
      description:
        "UNESCO World Heritage City with vibrant textiles, stepwells, and Gujarati culture.",
      mainImage:
        "https://images.unsplash.com/photo-1587554694700-c389f6c57c6a?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "A short and sweet heritage-rich journey through the streets of Ahmedabad.",
        },
      ],
    },

    {
      ...
      type: "domestic",
      description:
        "A serene Himalayan state offering pristine mountains, monasteries, and unforgettable views.",
      mainImage:
        "https://images.unsplash.com/photo-1587474260584-136574528ed4?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Enjoy the tranquil landscapes, spirituality, and clean mountain air of Sikkim.",
        },
      ],
    },

    {
      ...
      type: "domestic",
      description:
        "A land of pilgrimage and adventure nestled in the Himalayas, famous for its natural beauty and spiritual sites.",
      mainImage:
        "https://images.unsplash.com/photo-1564749515462-2be7f64407bb?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Perfect for a peaceful spiritual retreat with nature and yoga.",
        },
      ],
    },

    {
      ...
      type: "domestic",
      description:
        "A land of history, culture, rural beauty, and rapid urban growth in North India.",
      mainImage:
        "https://images.unsplash.com/photo-1596464716121-34bc5dc90a62?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Enjoy a mix of ancient Indian history and modern lifestyle in Haryana.",
        },
        {
          id: "p24",
...

    {
      ...
      name: "Andaman",
      description:
        "India's best nesting beaches for three species of marine turtles.",
      mainImage:
      ...
      packages: [
        {
          ...
          description:
            "Where the waters sparkle, the skies stretch endlessly, and every corner whispers you belong here.",
        },
    ...
    },
    {
      ...
      name: "Goa",
      description:
        "A vibrant mix of Indian and Portuguese cultures, sun-kissed beaches, and buzzing nightlife.",
      mainImage:
        "https://images.pexels.com/photos/1468081/pexels-photo-1468081.jpeg?auto=compress&cs=tinysrgb&w=600",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "A coastal paradise where the sun never sets on your happiness and every wave tells a story.",
        },
        {
          id: "p21b",
          ...
          description:
            "Explore the spirited side of Goa with comfort and charm on a budget-friendly escape.",
        },
      ],
    },
    {
      ...
      name: "Shimla",
      description:
        "The Queen of Hills, known for its colonial charm, snow-capped peaks, and serene landscapes.",
      mainImage:
        "https://images.pexels.com/photos/17432362/pexels-photo-17432362/free-photo-of-snow-covered-road-in-shimla.jpeg?auto=compress&cs=tinysrgb&w=600",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Experience the magic of snow, pine forests, and cozy hill-town charm in the lap of the Himalayas.",
        },
        {
          id: "p22b",
          ...
          description:
            "Walk through the colonial lanes of Shimla and relive its majestic history with a modern touch.",
        },
      ],
    },
    ...
    // Add more destinations with similar structure
    {
      ...
      type: "international",
      description:
        "Explore the city of love, iconic landmarks like the Eiffel Tower, and indulge in exquisite cuisine and fashion.",
      mainImage:
      ...
      packages: [
        {
          ...
          description:
            "A romantic escape in the heart of France with iconic sights, gourmet cuisine, and luxurious stays.",
        },
      ],
    },
    {
      ...
      type: "international",
      description:
        "Experience the perfect blend of tradition and futuristic innovation in Japan’s bustling capital city, Tokyo.",
      mainImage:
        "https://images.unsplash.com/photo-1576086213369-97a306d36512?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Dive into the heart of Japan with guided tours across Tokyo’s cultural, shopping, and entertainment hotspots.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Explore the city that never sleeps — from the Statue of Liberty to Times Square and Central Park, New York offers endless excitement.",
      mainImage:
      ...
      packages: [
        {
          ...
          description:
            "Discover the iconic landmarks, cultural diversity, and vibrant life of New York with our curated city tour.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Experience the charm of London — visit Big Ben, Buckingham Palace, Tower Bridge, and explore rich history and modern culture.",
      mainImage:
      ...
      packages: [
        {
          ...
          description:
            "Explore the vibrant culture and iconic landmarks of London in this unforgettable guided tour experience.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Experience the glitz and glamour of Dubai — a city where futuristic architecture, luxury shopping, and desert adventures await.",
      mainImage:
        "https://images.unsplash.com/photo-1573164574239-6f2b3d78ab56?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "A luxurious Dubai experience featuring iconic skyscrapers, thrilling desert adventures, and world-class shopping.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Explore the vibrant city of Singapore, where modern architecture meets rich culture and world-renowned attractions.",
      mainImage:
        "https://images.unsplash.com/photo-1549921296-3a6b5b27c340?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Discover the magic of Singapore with visits to iconic landmarks, thrilling theme parks, and stunning cityscapes.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Immerse yourself in the tropical paradise of Bali, renowned for its lush landscapes, serene beaches, and vibrant culture.",
      mainImage:
        "https://images.unsplash.com/photo-1546484959-f4460c6bde53?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Experience romance and relaxation in Bali with cultural tours, beach retreats, and unforgettable sunset views.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Explore the vibrant street life, tropical beaches, ornate temples, and rich cultural heritage of Thailand.",
      mainImage:
        "https://images.unsplash.com/photo-1506702315536-dd8b83e2dcf9?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Discover the perfect blend of adventure and relaxation in Thailand with thrilling island tours and vibrant nightlife.",
        },
      ],
    },

    {
      ...
      type: "international",
      description:
        "Experience the breathtaking beauty of the Swiss Alps, serene lakes, and charming villages. Switzerland offers a perfect blend of nature and culture.",
      mainImage:
        "https://images.unsplash.com/photo-1571055107559-3e67626a4cd3?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Embark on a journey through the heart of Europe and witness the awe-inspiring beauty of Switzerland’s natural and cultural wonders.",
        },
      ],
    },
          
    {
      ...
      type: "international",
      description:
        "Discover the land Down Under with its stunning beaches, iconic landmarks, and diverse wildlife. From the Sydney Opera House to the Great Barrier Reef, Australia has something for everyone.",
      mainImage:
        "https://images.unsplash.com/photo-1506976785307-8732e854ad5b?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Explore the vast landscapes, vibrant cities, and natural wonders of Australia with this comprehensive travel package covering all major highlights.",
        },
      ],
    },
    {
      ...
      type: "international",
      description:
        "Experience the rich history, art, and cuisine of Italy. From the Colosseum in Rome to the romantic canals of Venice, Italy offers timeless beauty and culture.",
      mainImage:
        "https://images.unsplash.com/photo-1526129318478-bbac2d2abf6f?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "Explore the romance and charm of Italy through its historic cities, iconic landmarks, and culinary delights.",
        },
      ],
    },
                                 ...
                                 
    {
      ...
      type: "international",
      description:
        "Enjoy the vibrant culture, flamenco music, stunning architecture, and Mediterranean beaches of Spain. A country where tradition and modernity blend beautifully.",
      mainImage:
        "https://images.unsplash.com/photo-1528198535492-2bd9bfc4d1e4?auto=format&fit=crop&w=800&q=80",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "From vibrant cities to rich cultural heritage and scenic coasts, this package offers the best of Spain in one memorable journey.",
        },
      ],
    },

    {
      ...
      mainImage:
        "https://plus.unsplash.com/premium_photo-1666286163385-abe05f0326c4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8bWFsZGl2ZXN8ZW58MHx8MHx8fDA%3D",
      images: [
      ...
      packages: [
        {
          ...
          description:
            "stunning natural beauty, including the crystal-clear waters.",
        },
      ],
    },
    {
  ...
  if (!destination)
    return <div className="text-center py-20">Loading destination...</div>;
      ...
      <section className="pt-28 pb-12">
        <div className="mx-auto max-w-[1340px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h1 className="text-[#261F43] md:text-5xl text-3xl font-bold mb-4">
              {destination.name}
            </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-1 gap-4">
                {destination.images.slice(0, 4).map((image, index) => (
                  <div
                    key={index}
                    className={`h-44 rounded-lg overflow-hidden cursor-pointer transition-all ${
                      activeImageIndex === index ? "ring-4 ring-[#E69233]" : ""
                    }`}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                  {getVisiblePackages().map((pkg) => (
                    <div
                      ...
                      onClick={() =>
                        navigate(`/destinations/${slug}/packages/${pkg.id}`)
                      }
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                ...
                <p className="text-gray-600">
                  Immerse yourself in the rich cultural heritage with
                  traditional performances, local festivals, and authentic
                  cuisine that will leave you mesmerized.
                </p>
              </div>
              <div>
                <h3 className="text-xl font-semibold mb-3 text-[#E69233]">
                ...
                <p className="text-gray-600">
                  From pristine beaches to lush mountains, experience nature at
                  its finest with breathtaking landscapes and diverse wildlife.
                </p>
              </div>
            </div>
          </div>
