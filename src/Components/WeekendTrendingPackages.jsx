...
//         // console.log("Fetched Packages:", responseData);

//         // Filter only on classification includes 'weekend'
//         const filteredPackages = (responseData || []).filter(pkg => {
//           return Array.isArray(pkg.classification) && pkg.classification.includes('weekend');
//         });
...
//       const totalScroll = container.scrollWidth / 2; // duplicate cards for infinite scroll
